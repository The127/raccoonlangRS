...
mod test {
    ...
    fn transform_single_add() {
        ...
        assert_eq!(
            ...
            Expression::binary(
                span,
                BinaryOperator::Add.spanned(2),
                Expression::i32_literal(0, 1),
                Expression::i32_literal(4, 2)
            ),
        );
    }
    ...
    fn transform_multi_add() {
        ...
        assert_eq!(
            ...
            Expression::binary(
                span_1 + span_3,
                BinaryOperator::Sub.spanned(span_minus),
                Expression::binary(
                    span_1 + span_2,
                    BinaryOperator::Add.spanned(span_plus),
    ...
    fn transform_multi_mul() {
        ...
        assert_eq!(
            ...
            Expression::binary(
                span_1 + span_3,
                BinaryOperator::Div.spanned(span_div),
                Expression::binary(
                    span_1 + span_2,
                    BinaryOperator::Mul.spanned(span_mul),
                    Expression::i32_literal(span_1, 1),
                    Expression::i32_literal(span_2, 2),
                ),
                Expression::i32_literal(span_3, 3)
